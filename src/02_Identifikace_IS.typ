...
IS má za účel podporovat podnik v jeho procesech.
Svým charakterem IS podporuje podnikové procesy komunikace s cestujícími.
...
Aktualizace jízdních řádů představuje pravidelný provozní proces IS, který úzce navazuje na podnikové procesy dopravce.
...
Pro zavedení nové zastávky do systému je za potřeba provést kroky navíc.
Samotné zastávky mají vazbu na data jízdních řádů a proto je třeba zaručit validaci na správnou identifikaci zastávky.
...
Vyměnit ikonky vozidel v aplikaci je nyní možné skrze vydání nové verze IS.
