...
Zavedení nové zastávky do systému probíhá v aktuálním IS současně s aktualizací jízdního řádu.
...
Výměna ikonky vozidel v aplikaci je nyní možná pouze pomocí vydání nové verze aplikace.
