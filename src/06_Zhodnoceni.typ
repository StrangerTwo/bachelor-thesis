...
Cílem této kapitoly je zhodnotit návrh nového IS.
Kapitola odpovídá poslednímu kroku funkční analýzy IS, *dokumentace výsledků analýzy*.
@StairReynolds2018
...
V případě úspěšné implementace navrženého řešení existuje několik možných směrů pro další rozvoj systému.
Jednou z možností je rozšíření integrace s dalšími informačními systémy dopravce.
Dopravci běžně využívají specializované systémy například pro správu tarifů, evidenci jízdného nebo poskytování různých forem slev pro cestující.

Integrací těchto systémů s navrženým IS by bylo možné rozšířit funkcionalitu aplikace například o správu profilu cestujícího nebo o personalizované služby.
Dalším možným krokem rozvoje systému může být také implementace platebních funkcí, které by umožnily přímý nákup nebo správu jízdného prostřednictvím aplikace.
