...
===== Hardware
fyzická zařizení, jako třeba servery, počítatě, mobilní telefony, které sbírají a zpracovávají data.
...
Mohou zahrnovat data o jízdních řádech, geografické informace o polohách vozidel, nebo actuální feed informací o zpoždění.
...
Je možné využít grafického znázornění stávajícícho stavu pomocí diagramů.
Diagram toku dat Data Flow Diagram - DFD, zobrazuje tok dat, procesy a uložiště.
...
V tomto kroce dojde k vymezení rozsahu analýzy, tedy kterých částí podniku a které procesy budou předmětem zkoumání.
...
Na zákledně zjištěných nedostatků dojde k návrhu nových procesů po jejich optimalizaci.
